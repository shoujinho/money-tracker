...
function TransactionModal({ mode, tx, accounts, onSave, onDelete, onClose }) {
  ...
  return (
    <div onClick={(e) => { if (e.target === e.currentTarget) onClose() }} style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', background: 'rgba(5,5,12,0.80)', padding: '32px 20px 20px', overflowY: 'hidden' }}>
